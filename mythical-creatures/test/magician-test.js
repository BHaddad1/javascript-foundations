...
it('should have a name with The Great in front of it', function() {
...
it('should only have an assistant for Scott', function() {
...
it('should perform a trick', function() {
...
it('should perform a different trick', function() {
...
it('should have a confidence percentage', function() {
    var magician = new Magician({ name: 'Leta' });

    assert.equal(magician.confidencePercentage, 10);
  });

it('should increase confidence level when a trick is performed', function() {
    var magician = new Magician({ name: 'Leta' });
...
it('should have the magician perform a showstopper once their confidence level increases', function() {
...
it('should only be able to perform a Show Stopper if the magician does not have an assistant', function() {
